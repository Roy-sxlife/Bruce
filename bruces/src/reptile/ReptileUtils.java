...
public class ReptileUtils {
     ...
     * @return
     */
    public static boolean getAllSongs(int pageId) {
...
//        map.put(4003, "其他组合/乐队");
        ...
        String singerUrl = "https://music.163.com/discover/artist/cat?id="+pageId+"&initial=76";
            ...
            for (Element element : elements) {
                ...
                try {
                    String res2 = Jsoup.connect(songUrl)
                            ...
                            .method(Connection.Method.GET)
                            // 设置请求头等信息，模拟人工访问，超时时间可自行设置
                            .timeout(50000).execute().charset("utf-8").body();
...
//                    System.out.println(insert);
                    ...
                    for (Element el : songElements) {
                        ...
                        song.setLyric(lyric);
                        song.setUrl(songRealUrl);
                        song.setPic(songPic);
                        song.setAlbumName(albumName);
                        song.setName(title);
                        song.setDuration(realSongTime);
                        song.setSingerName(singerName);
                        song.setIsDownload(0);
                        song.setPlayCount(0);
