define( function ( require, exports, module ) {
	...
	Result.prototype._init = function() {
		...
		if ( url.indexOf("?") !== -1) {
			...
			$.get("http://localhost:8080/bruceweb/UpAndDownloadServlet",{method:"getMInfo",id:data_id},function ( result ) {	//get歌曲信息
			...
			$.post("http://localhost:8080/bruceweb/UpAndDownloadServlet",{method:"getlyric",id:data_id},function (res) {	//get歌词
				var html = '';
				if (res.length > 6) {
