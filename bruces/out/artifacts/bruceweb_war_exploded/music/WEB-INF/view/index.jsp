...
<head>
	<meta charset="UTF-8">
	<title>Bruce~音乐分享</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/music/css/frame.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/music/css/music.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/music/css/index.css">
    <link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/music/image/favicon.ico" />
</head>
<body>	
<div class="header">
	<div class="header-center center">
		<h1>Bruce 音乐场</h1>
		<ul class="nav">
			<li><a href="javascript:;" class="active" target="_blank">发现音乐</a></li>
			<li><a href="javascript:;" target="_blank">我的音乐</a></li>
			<li><a href="javascript:;" target="_blank">热门专辑</a></li>
			<li><a href="javascript:;" target="_blank">在线好友</a></li>
		</ul>
		<div class="top-tool">
	...
	<div class="sub-list">
		<div class="center">
			<ul class="sub-nav">
				<li><a class="active" href="javascript:;" target="_blank">推荐</a></li>
				<li><a href="javascript:;" target="_blank">排行榜</a></li>
				<li><a href="javascript:;" target="_blank">歌单</a></li>
				<li><a href="javascript:;" target="_blank">主播电台</a></li>
				<li><a href="javascript:;" target="_blank">歌手</a></li>
				<li><a href="javascript:;" target="_blank">新碟上架</a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="wrap">
	<div class="wrap-in">
		...
		<div class="cloumn main-top">
            ...
            <div class="slides">
                <ul class="points">
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/player-1.jpg" alt="图片-1"/></a></li>
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/player-2.jpg" alt="图片-2"/></a></li>
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/player-3.jpg" alt="图片-3"/></a></li>
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/player-4.jpg" alt="图片-4"/></a></li>
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/player-5.jpg" alt="图片-5"/></a></li>
                </ul>
                <ul class="sub-tips">
        ...
        <div class="column main-type">
            ...
            <div class="acts">
                <ul class="acts-list">
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/hit-1.jpg" alt=""></a></li>
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/hit-2.jpg" alt=""></a></li>
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/hit-3.jpg" alt=""></a></li>
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/hit-4.jpg" alt=""></a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="column main-pro">
            <div class="section">
                ...
                <ul class="pro-list">
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/view-1.jpg" alt=""></a></li>
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/view-2.jpg" alt=""></a></li>
                    <li><a href="javascript:;"><img src="${pageContext.request.contextPath}/music/image/view-3.jpg" alt=""></a></li>
                </ul>
            </div>
            <div class="sidebar"><img src="${pageContext.request.contextPath}/music/image/wrap.png" alt=""></div>
        </div>
        ...
        <div class="column main-hot">
            ...
            <div class="section">
                ...
                <ul class="hot-list">
                    <li><img src="${pageContext.request.contextPath}/music/image/player-2.jpg" alt=""></li>
                    <li><img src="${pageContext.request.contextPath}/music/image/player-3.jpg" alt=""></li>
                    <li><img src="${pageContext.request.contextPath}/music/image/player-4.jpg" alt=""></li>
                    <li><img src="${pageContext.request.contextPath}/music/image/player-5.jpg" alt=""></li>
                </ul>
            </div>
        </div>
        ...
        <div class="column main-rank">
            <div class="section">
                ...
                <div class="rank">
                    <dl class="rank-blk">
                        <dt class="top">
                            <a href="javascript:;" class="dt-img"><img src="${pageContext.request.contextPath}/music/image/musicUp.jpg" alt=""></a>
                            <div class="dt-txt">
                    ...
                    <dl class="rank-blk">
                        <dt class="top">
                            <a href="javascript:;" class="dt-img"><img src="${pageContext.request.contextPath}/music/image/musicNew.jpg" alt=""></a>
                            <div class="dt-txt">
                    ...
                    <dl class="rank-blk">
                        <dt class="top">
                            <a href="javascript:;" class="dt-img"><img src="${pageContext.request.contextPath}/music/image/musicCreate.jpg" alt=""></a>
                            <div class="dt-txt">
...
<div class="fix-bottom">
    ...
    <div class="fix-play">
        ...
        <div class="play-head">
            <a href="#" target="_blank"><img src="${pageContext.request.contextPath}/music/image/default_album.jpg" alt=""></a>
        </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/music/sea-modules/seajs/sea.js"></script>
