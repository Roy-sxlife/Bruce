...
define(function (require, exports, module) {
    ...
    Player.prototype.render = function() {
        ...
        this._bind();                   // 启动事件监听器
        $.get("http://localhost:8080/bruceweb/UpAndDownloadServlet",{method:"getmusic"},function(res) {
    ...
    Player.prototype.init = function (data_id) {   // data.src, data.name, data.master
        var self = this;
        $.get("http://localhost:8080/bruceweb/UpAndDownloadServlet",
            {
                method:"getMInfo",
                id:data_id
            },
    ...
    Player.prototype._bind = function() {
        ...
        $(this.audio).on('loadstart', function() {     // 正在加载 loading
            ...
            $.get("http://localhost:8080/bruceweb/UpAndDownloadServlet",
                ...
                $('.play-head a').attr('href', '/bruceweb/music/WEB-INF/view/result.html?id='+json.music_id);
                $('.play-ing .ptitle a').attr('href', '/bruceweb/music/WEB-INF/view/result.html?id='+json.music_id);
