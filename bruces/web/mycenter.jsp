...
<div class="backgroudbody">
    <ul class="topnav">
        ...
        <li style="padding-left: 30px;"><a href="publish.jsp" style="text-decoration: none;color: #FFFFFF;">发 布</a></li>
        <li style="padding-left: 30px;"><a href="publish.jsp" style="text-decoration: none;color: #FFFFFF;">消 息</a></li>
        <li style="float: right;padding-right: 60px;width: 100px"><a href="${pageContext.request.contextPath}/MyInformServlet" style="text-decoration: none;color: #FFFFFF;" target="_blank">个人信息</a></li>
        <li style="float: right;padding-right: -10px;width: 100px"><a href="${pageContext.request.contextPath}/visitor.jsp" style="text-decoration: none;color: #FFFFFF;" target="_blank">访客记录</a></li>
    </ul>
    <div class="nav">
        <p class="selftitle" style="padding-top: 350px;">欢迎来到</p>
        <p class="selftitle">${User.username}的个人空间</p>
    </div>
    <c:forEach items="${UserStatus}" var="statusList">
    <div class="publish-content" id="publish-content${statusList.status_id}">
        <div class="myhead" style=" background-image: url(${pageContext.request.contextPath}/resources/picture/${statusList.user.photo});"></div>
        <p style="margin-top: 38px;float: left;margin-left: 20px;"> <a  style="text-decoration: none" target="_blank" href="${pageContext.request.contextPath}/CenterServlet?method=ShowAll&user_Id=${statusList.user.id}">${statusList.user.username}<a/></p>
        <p style="margin-top: 42px;float: left;margin-left: 30px;font-size: 13px;color: #666;">发布时间:${statusList.create_time}</p>
        <a href="${pageContext.request.contextPath}/UpdateServlet?method=status&status_id=${statusList.status_id}"  style="text-decoration: none;color: #666666;"><p style="margin: 0;font-size: 12px;float: right;margin-top: 45px;">编辑</p></a>

        <a href="javascript:;" onclick="todelete(${statusList.status_id})" style="text-decoration: none;color: #666666;"><p style="margin: 0;font-size: 12px;float: right;margin-top: 45px;margin-right: 10px">删除</p></a>
            ...
            <div class="backgroud">
                <form action="" id="form${statusList.status_id}">
                    <div>
                        ...
                        <div style="clear:both"></div>
                        <input type="reset" value="重置" style="opacity: 0.7;"/>
                        <button href="javascript:;" type="button" onclick="addRemark(${statusList.status_id})" style="margin-left: 30px;opacity: 0.7;" >确认评论</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    function todelete(d) {
       var delete_id=d;
        if(window.confirm('你确定要删除动态吗？')){
            ...
            xmlHttpRequest.onreadystatechange=function(){
                if(xmlHttpRequest.readyState == 4&&xmlHttpRequest.status == 200) {
                    ...
                    if (data=="true"){
                        ...
                        document.getElementById("publish-content"+delete_id).remove();
                    }
                }
            }
            ...
            xmlHttpRequest.send("method=delete&delete_id="+delete_id);
