...
<div class="backgroudbody">
    <ul class="topnav">
        ...
        <li style="padding-left: 30px;"><a href="" style="text-decoration: none;color: #FFFFFF;">发消息</a></li>
        <li style="float: right;padding-right: 60px;width: 100px"><a href="${pageContext.request.contextPath}/MyInformServlet?userId=${otherUser.id}" style="text-decoration: none;color: #FFFFFF;" target="_blank">个人信息</a></li>
    </ul>
    <div class="nav">
        <p class="selftitle" style="padding-top: 350px;">欢迎来到</p>
        <p class="selftitle">${otherUser.username}的个人空间</p>
    </div>
